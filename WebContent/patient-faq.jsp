                ...
                <div class="row breadcrumb-bar">
                    ...
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">医患留言</li>
                        </ol>
                    </div>
                </div>
            </div>
                        ...
                        <div class="widget-area-2 lochana-box-shadow">
                            ...
                            <div class="lochana-widget">
                                ...
                                <div id="faq1" class="faq-block" role="tablist" aria-multiselectable="true">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="adminssion-date">消息版</label>
                                        <input type="text" placeholder="massage" class="form-control" id="massage_id">
                                    </div>
