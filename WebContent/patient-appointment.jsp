                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">预约医生</h3>
                            <form>
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label for="patient-id">患者id</label>
                                        <input type="text" class="form-control" placeholder="患者id" id="patient_id">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="patient-name">患者姓名</label>
                                        <input type="text" class="form-control" placeholder="名人姓名" id="patient_name">
                                    </div>

                                    <div class="form-group col-md-6">
                                        <label for="doctor-name">医生id</label>
                                        <input type="text" placeholder="医生id" class="form-control" id="doctor_id">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="adminssion-date">开始时间</label>
                                        <input type="date" placeholder="Adminssion Date" class="form-control" id="appointment_time">
                                    </div>
                                    ...
                                    <div class="form-check col-md-12 mb-2">
                                        <div class="text-left">
                                            <div class="custom-control custom-checkbox">
                                                ...
                                                <label class="custom-control-label" for="ex-check-2">请确认信息</label>
                                            </div>
                                        </div>
                                    </div>
